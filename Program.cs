...
while (true)
{
    ...
    if (category == "A")
    {
        ...
        if (category_A_answer_2 == "seven" || category_A_answer_2 == "7")
        {
          Console.WriteLine("\nCorrect answer");
        }
    ...
    if (category == "B")
    {
        ...
        if (category_B_answer_2 == "playstation 2" || category_B_answer_2 == "ps2")
        {
          Console.WriteLine("\nCorrect answer");
        }
        Console.WriteLine("\nQuestion 3:");
        ...
        if (category_B_answer_3 == "random number generator")
        {
          Console.WriteLine("\nCorrect answer");
        }
    }
  Console.WriteLine($"\nCongrats {nameS}, you completed the quiz!");
  Task.Delay(1500).Wait();
